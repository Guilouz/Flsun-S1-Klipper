...
INPUT_SHAPERS = [
    ...
    InputShaperCfg('mzv', get_mzv_shaper, min_freq=21.),
    InputShaperCfg('zvd', get_zvd_shaper, min_freq=21.),
    InputShaperCfg('ei', get_ei_shaper, min_freq=21.),
    InputShaperCfg('2hump_ei', get_2hump_ei_shaper, min_freq=21.),
    InputShaperCfg('3hump_ei', get_3hump_ei_shaper, min_freq=21.),
    InputShaperCfg('zv_zvd', get_zv_zvd_shaper, min_freq=21.),
    InputShaperCfg('zero_zv', get_zero_zv_shaper, min_freq=21.),
    #InputShaperCfg('zero_zvd', get_zero_zvd_shaper, min_freq=21.),
]